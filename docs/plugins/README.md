...
You can clone this repository and checkout to [`plugin/base`](https://github.com/fallen0047/dashboard/tree/plugin/base) branch. The build process is specified under [`builders`](https://github.com/fallen0047/dashboard/tree/plugin/base/builders) directory.
...
----
_Copyright 2021 [The Kubernetes Dashboard Authors](https://github.com/fallen0047/dashboard/graphs/contributors)_