...
```shell
kubectl create -f https://raw.githubusercontent.com/kubernetes/dashboard/v2.4.1/aio/deploy/alternative.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/kubernetes/dashboard/v2.4.1/aio/deploy/head.yaml
```
