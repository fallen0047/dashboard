...
import (
	...
	"github.com/fallen0047/dashboard/src/app/backend/cert"
	...
	"github.com/fallen0047/dashboard/src/app/backend/handler"
...
var (
	...
	argPort                      = pflag.Int("x", 8443, "secure port to listen to for incoming HTTPS requests")
...
func handleFatalInitError(err error) {
	log.Fatalf("Error while initializing connection to Kubernetes apiserver. "+
		...
		"https://github.com/fallen0047/dashboard/wiki/FAQ", err)
}
