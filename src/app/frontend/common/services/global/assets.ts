...
export class AssetsService {
  ...
  constructor(
    ...
    iconRegistry_.addSvgIcon(
      this.appLogoIcon2_,
      sanitizer_.bypassSecurityTrustResourceUrl(`${this.assetsPath_}/${this.appLogoSvg2_}`)
    );
    iconRegistry_.addSvgIcon(
